...
const char * smtp_server = "smtp.163.com";
...
const char * message = "Hello world!\r\n.\r\nThird line\r\nSome accented letters: no newline.";
const char * subject = "Test subject, accented letters: qitas";
...
void loop() {
    ...
    if(!finished && (WiFiMulti.run() == WL_CONNECTED)) {
      ...
      result = smtp.sendMessage(smtp_user, message, strlen(message), to, subject);
